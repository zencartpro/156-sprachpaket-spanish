...
define('TEXT_MENU_KEY', 'Añadir al Menú');
...
define('ERROR_LANGUAGE_KEY_HAS_NOT_BEEN_DEFINED', 'La clave de idioma no ha sido definida. Compruebe que está escrita correctamente.');
