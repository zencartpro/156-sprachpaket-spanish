...
define('MODULES_PAYMENT_PAYPALWPP_MESSAGE_STACK_CHECKOUT_SHIPPING', 'Usted paga con PayPal y utiliza una dirección de entrega depositada en PayPal.<br/>Queremos asegurarnos de que esta dirección de entrega es correcta, por lo que le redirigimos a esta página.<br/>Por favor, compruebe la dirección de entrega y cámbiela si es necesario.<br/>¿La dirección es correcta? Bien!<br/>Pulse en continuar en la esquina inferior derecha y luego confirme de nuevo en el último paso con el botón Comprar.<br/>PayPal El pago y el pedido sólo se procesará después de confirmar el pedido de esta manera.');